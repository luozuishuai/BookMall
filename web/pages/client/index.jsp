	...
	$(function () {
		$("button.addItem").click(function () {
			...
			<%--$.getJSON("${basePath}"" + cartServlet","action=ajaxAddItem&id=" + id,function (data) {--%>
				<%--var cartTotalCount = data.cartTotalCount;--%>
				<%--var bookName = data.bookName;--%>
				<%--$("#cartTotalCount").text("您的购物车中有"+ cartTotalCount +"件商品");--%>
				<%--$("#lastBookName").html("您刚刚将<span style=\"color: red\">"+ bookName +"</span>加入到了购物车中");--%>
            <%--})--%>
        });
    });
</script>
			...
			<div class="b_list">
				...
				<div class="book_info">
					...
					<div class="book_price">
						...
						<span class="sp2" id="bookName">￥${book.price}</span>
					</div>
